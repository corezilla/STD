...
版本：0.6.0-draft.2 · 日期：2026-09-12 · 状态：编写方法草案，待完整写作任务验证
...
本轮修订输入基线：STD commit `bc67a74b9b7ea5ed0e0a4db0af6f9a9b3b21193b`，包含系统模板
`8.1.0`、机制模板 `2.0.0` 和本指南 `0.6.0-draft.1`。本版保留系统模板 17 章及其方法，
在 §3.4 补充机制父子归属与独立依赖；机制模板 `2.1.0` 的 16 章写法、九幅图文样板及完整案例
...
| `design.definition` | 1.2.0 | 固定上级约束和接口成员基线到实现/验证 |
| `design.hardware`、`design.fpga` | 各 1.2.0 | 信号/寄存器和系统分配使用同一标识及固定来源 |
| `design.system-mechanism` | 2.1.0（待发布） | 16 主章；承接机制父子身份，保留数据/接口、机器契约及下游映射 |
