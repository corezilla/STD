...
版本：0.3.1-draft.12 · 日期：2026-09-10 · 状态：编写方法草案，待完整写作任务验证
...
本轮修订输入基线：STD commit `4218437c7cc3c56fa5ad24e3ac3447a648fbb221`，包含系统模板
`6.4.0` 和本指南 draft.11。本版对应同目录的待发布系统模板 `7.0.0`：第 3 章合并概览与结构，
第 5 章先讲完整业务过程，再讲启动和配置；后续技术章顺移为 §6–17。原有图形样式与专项模板
保持不变。`7.0.0` 及本指南修订以各自版本、实际文件摘要和所在提交为准，不倒称已包含在输入
基线或旧发布标签中。下表为本版对应关系：

| 方法来源 | 本版核对版本 | 在写作中的用途 |
|---|---|---|
| `design.system` / `architecture-design.md` | 7.0.0（待发布） | 短封面、§3 架构/职责/映射、§5 业务与生命周期过程、§17.2 下级设计与验收任务 |
