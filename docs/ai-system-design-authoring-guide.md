...
版本：0.6.0-draft.1 · 日期：2026-09-12 · 状态：编写方法草案，待完整写作任务验证
...
本轮修订输入基线：STD commit `fef1a61612a50ab09a85dcd65b65f2fec67e58ff`，包含系统模板
`8.0.0`、机制模板 `1.5.1` 和本指南 `0.5.0-draft.3`。本版保留系统模板 17 章及其方法，
新增 §3.4 机制规划与数据/接口映射；机制模板 `2.0.0` 的 16 章写法、九幅图文样板及完整案例
...
| 方法来源 | 本版核对版本 | 在写作中的用途 |
|---|---|---|
| `design.system` / `architecture-design.md` | 8.1.0（待发布） | 17 主章；新增机制清单与预定文件映射、接口/数据统一成员索引 |
| `design.definition` | 1.2.0 | 固定上级约束和接口成员基线到实现/验证 |
| `design.hardware`、`design.fpga` | 各 1.2.0 | 信号/寄存器和系统分配使用同一标识及固定来源 |
| `design.system-mechanism` | 2.0.0（待发布） | 16 主章；独立数据/接口章节、完整机器契约与下游映射；原图文边界保留 |
...
系统模板 §3.4 在总体设计时先登记机制 ID、Document ID、预定文件名、范围、Owner/依赖与写作状态。
